...
const projects: { labelEn: string; labelEs: string; size: Size; src: string }[] = [
  ...
  { labelEn: "Natural Grass",            labelEs: "Grama Natural",            size: "tall",      src: "/img/img-04.jpeg" },
  ...
  { labelEn: "Synthetic Grass",         labelEs: "Grama Sintética",         size: "standard",  src: "/img/img-16.jpeg" },
  { labelEn: "Synthetic Grass",          labelEs: "Grama Sintética",          size: "wide",      src: "/img/img-17.jpeg" },
