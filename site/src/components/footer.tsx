      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-12 py-16 lg:py-20">
        <div className="grid gap-12 lg:grid-cols-3">
          ...
          <div>
            ...
            <p className="text-sm leading-relaxed max-w-xs text-cream/40">
              Landscaping, hardscape, and garden maintenance for homeowners who
            ...
            <ul className="space-y-4">
              <li>
                <a
                  ...
                  className="flex items-center gap-3 text-sm text-cream/60 hover:text-cream transition-colors duration-200"
                >
              ...
              <li>
                <a
                  href="mailto:contact@obagustin.com"
                  className="flex items-center gap-3 text-sm text-cream/60 hover:text-cream transition-colors duration-200"
                >
                  <Mail className="w-4 h-4 text-sage/60" aria-hidden="true" />
                  contact@obagustin.com
                </a>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-3">
              {[
                ...
                <li key={link.href}>
                  <a
                    href={link.href}
                    className="text-sm text-cream/45 hover:text-cream transition-colors duration-200"
                  >
                    {link.label}
                  </a>
                </li>
        ...
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-xs text-cream/25">
            &copy; {currentYear} work JP. All rights reserved.
          </p>
